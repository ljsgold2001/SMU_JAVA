	...
	public class MyMouseListener implements MouseListener, MouseMotionListener {
		...
		public void mouseClicked(MouseEvent e) {
			...
			if (b.getText().equals("삭제")) {
				...
				tf1.append(tfname.getText()+"님 삭제  완료되었습니다>" + "\n");
				tfname.setText("");
				tfphone.setText("");
				tfaddress.setText("");
			}
